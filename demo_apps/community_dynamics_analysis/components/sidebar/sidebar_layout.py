    ...
    className="sidebar",
        children=[
            ...
            html.Label([html.Span(
             ...
             dbc.Tooltip(
                "Type the organization and name of the desired repository (e.g. chaoss, augur). "
                "For a valid input, the selected repository must be present in the Augur database.",
                target="repo-tooltip",
            ...
            html.Div(id="error-message", style={"color": "red", "margin-top": "10px"}), # error message if repo not in database
